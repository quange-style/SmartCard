...
unsigned char MifareProCom(unsigned char cpLength,unsigned char *lpdata, unsigned short int *respone_sw)
{
	...
	{
		sprintf(&sztmp[2*i],"%02x",lpdata[i]);
	}*/

	//g_Record.log_out(0, level_error, "MifareProCom(indata)");
	//for(i=0;i<cpLength;i++)
	//{
		//g_Record.log_out(0, level_error, "MifareProCom(indata=%s)",sztmp);
	//}
	...
	*respone_sw=sw;
    ...
    //for(i=0;i<len;i++)
    //{
        //g_Record.log_out(0, level_error, "MifareProCom(outdata=%s)",sztmp);
    //}
