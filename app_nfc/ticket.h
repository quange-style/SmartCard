...
typedef unsigned char ETYTKOPER;
	//========================================================
	...
	//       0=成功
	//========================================================
	extern int sam_hst_active(int nsamsck, unsigned char * p_len_sam_id, unsigned char * p_sam_id, unsigned char * p_len_terminal_id, unsigned char * p_terminal_id);


		//========================================================
	//功能:对交通部SAM  进行初始化,  一般设备上电进入工作状态前必做一次
	//入口参数
	//	 nsamsck=sam卡对应卡槽
	//出口参数
	//       saminf=6字节的sam  卡号
	...
	//       0=成功
	//========================================================
	extern int octjtb_saminit(int nsamsck, unsigned char * p_len_sam_id, unsigned char * p_sam_id, unsigned char * p_len_terminal_id, unsigned char * p_terminal_id);
	...
	extern unsigned short search_qr_card_ex(unsigned char *lpcardno, unsigned char& type);
	extern unsigned short search_third_card_ex(unsigned char *lpcardno, unsigned char& type);
	...
	extern uint16_t svt_updata_more_complex_hst(unsigned char tac_type, unsigned char * p_time_now, int nsamsck, 
		unsigned char *lplogicnumber, long lAmount, unsigned char recordcnt,
	...
	extern uint16_t svt_updata_more_complex_hst_dis(unsigned char tac_type, unsigned char * p_time_now, int nsamsck, 
		unsigned char *lplogicnumber, long lAmount, unsigned char recordcnt,
		unsigned char *dim_record_id, unsigned char *dim_lock, unsigned char *dim_lpfile, unsigned char *discount_lpfile, unsigned char *respone_data);
		
	extern uint16_t svt_hst_lock_card(int nsamsck,unsigned char *lplogicnumber);

	extern int jtb_lock_card(int nsamsck,unsigned char *lplogicnumber, unsigned char *issueno);
	...
	//       0=成功
	//========================================================
	extern uint16_t jtb_updata_more_complex(ETYTKOPER operType,unsigned char tac_type, unsigned char * p_time_now, int nsamsck,
	...
	extern void get_qrClearInfo(uint8_t * p_grInfo, uint8_t * key);

	//判断是否是交通部CPU卡
	extern unsigned short search_jtbcpu(unsigned char * p_pid, unsigned char& type);
