...
#ifndef __SERIALLOCAL_H__
#define __SERIALLOCAL_H__
...
//========================================================
int libserial_recv_package_local(const int maxrecv, int timeout, uchar *buf);
...
//       >0=有正确的数据报文件，返回整个报文长度
//========================================================
int libserial_recv_package_local_ble(ETBLEOPER operType,const int maxrecv, int timeout, uchar *buf);
