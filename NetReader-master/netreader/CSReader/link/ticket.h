...
extern "C"
{
	...
	extern unsigned short search_card_ex(unsigned char *lpcardno, unsigned char& type, ETYTKOPER oper_type = operNone);
	...
	extern unsigned short search_card_type(char * cCenterCodeIn, char * type);
	...
	extern void get_qrHeadVersion(uint8_t * p_grInfo);
