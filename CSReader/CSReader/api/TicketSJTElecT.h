...
}SJT_ETICKET_ENTRY_INF, * P_SJT_ETICKET_ENTRY_INF;
...
}SJT_ETICKET_EXIT_INF, * P_SJT_ETICKET_EXIT_INF;
...
}SJT_ETICKET_GET_INF, * P_SJT_ETICKET_GET_INF;
...
}SJT_METRO_ELECT_INF, * P_SJT_METRO_ELECT_INF;


class TicketSJTElecT : public TicketBase
{
...
public:
	TicketSJTElecT(void);
	TicketSJTElecT(char * p_current_sam, char * p_sam_posid, uint8_t * physic_info);
	~TicketSJTElecT(void);
...
protected:
	...
	SJT_METRO_ELECT_INF m_ReadInf;

	uint16_t metro_elec_read(P_SJT_METRO_ELECT_INF p_mtr_inf);

	SJT_METRO_ELECT_INF file_need_read(ETYTKOPER type, uint8_t * p_buffer);
	SJT_METRO_ELECT_INF file_need_write(ETYTKOPER type, P_SJT_METRO_ELECT_INF p_read_inf);
	...
	//void get_qrHeadInfo(uint8_t * p_grInfo);
