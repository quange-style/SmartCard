...
void CDlgParam::OnBnClickedBnCur()
{
	...
	BYTE bRecv[512] = {0};
	BYTE bData[8] = {0};
	int nType[] = { 0x0101,0x0202, 0x0203, 0x0204, 0x0301, 0x0302, 0x0303, 0x0400, 0x0501, 0x0601, 0x0602, 0x0603, 0x0604, 0x0605, 0x0606, 0x0801, 0x9120, 0x9220, 0x9320, 0x9420, 0x9620};
